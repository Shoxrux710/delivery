...
const AllAgents = (props) => {
    ...
    const { setIsModalVisible, isModalVisible, fullname, setFullname, login, setLogin, password, setPassword, regionId, setRegionId, phone, setPhone, addAgent, regions, allAgents, loader } = props
