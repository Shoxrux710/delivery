...
import '../agents/allAgentsInManager.css'

const AllKuryersInManager = (props) => {

    const { setIsModalVisible, isModalVisible, fullname, setFullname, login, setLogin, password, setPassword, phone, setPhone, addKuryer, allKuryers, loader, userData } = props
...
export default AllKuryersInManager